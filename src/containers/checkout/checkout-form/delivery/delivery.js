...
const Delivery = ({ isLightTheme, language, deliveryType, values, errors, touched, handleChange, setFieldValue }) => (
  <>
    ...
    {deliveryType === deliveryTypes.NOVAPOST && (
      <NovaPost setFieldValue={setFieldValue} language={language} isLightTheme={isLightTheme} values={values} errors={errors} touched={touched} handleChange={handleChange} />
    )}
