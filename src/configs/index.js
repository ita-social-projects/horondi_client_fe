...
export const formRegExp = {
  ...
  zipcode: /^\d{5}(?:[-\s]\d{4})?$/,
  country: "^(?=.{2,40}$)[a-zA-Zа-яА-ЯіїєІЄй]+(([',. -][a-zA-Zа-яА-Яіїє])?[a-zA-Zа-яА-ЯіїєІЄй]*)*$",
  city: "^(?=.{2,40}$)[a-zA-Zа-яА-ЯіїєІЄй]+(([',. -][a-zA-Zа-яА-Яіїє])?[a-zA-Zа-яА-ЯіїєІЄй]*)*$",
  region: "^(?=.{2,40}$)[a-zA-Zа-яА-ЯіїєІЄй]+(([',. -][a-zA-Zа-яА-Яіїє])?[a-zA-Zа-яА-ЯіїєІЄй]*)*$",
  street: "^(?=.{2,40}$)[a-zA-Zа-яА-ЯіїєІЄй]+(([',. -][a-zA-Zа-яА-Яіїє])?[a-zA-Zа-яА-ЯіїєІЄй]*)*$",
