...
const EditableField = ({ setEditable, text, handleOpen, commentId, username }) => {
	const styles = useStyles();
	const dispatch = useDispatch();

	const { language, productId, userEmail } = useSelector(({ Products, Language, User }) => ({
	...
	return (
		<div>
			<TextField
				...
				helperText={
					!textValidated && shouldValidate ? `${errorMessages[language].value.text}` : ''
				}
				type="text"
				name={TEXT}
			/>
